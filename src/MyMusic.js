...
import sound from './assets/music/Nasha.mp3'
        ...
        return(
            <div style={styles.myMusicContainer}>
                ...
                <div style={styles.info}>
                    <img style={styles.image} src="https://paglasongs.com/uploads/thumb/sft5/2475_4.jpg"></img>
                    <div style={styles.subInfo}>
                        <h4 style={{marginBottom:'0.5rem'}}>Konsa Nasha Karta Hai </h4>
                        <p style={{marginBottom:'0'}}>Afsana Khan</p>
                        <p>Avvy Sra</p>
                    </div>
